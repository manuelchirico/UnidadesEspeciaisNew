    ...
    <div class="modal fade" id="activityLogModal" tabindex="-1" role="dialog" aria-labelledby="activityLogModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!-- Display user's activity log here -->
                    <ul>
                        <!-- Example activity log items -->
                        <li>Logged in at 10:00 AM</li>
                        <li>Updated profile at 10:30 AM</li>
                        <!-- Add actual activity log items from the database -->
                    </ul>
                </div>
            </div>
        </div>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; UNILICUNGO Website 2024</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
